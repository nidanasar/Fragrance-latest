...
const reviews = [
  {
    ...
    rating: 5,
    review: "De-Hac has truly redefined luxury fragrances in Pakistan. 'Blossom' is an absolute masterpiece—it captures the essence of a blooming garden with such sophistication. The longevity is better than many international niche brands I own.",
    product: "Blossom",
    image: "https://images.unsplash.com/photo-1494790108377-be9c29b29330?w=150&q=80",
    verified: true
  },
  {
    ...
    rating: 5,
    review: "'His-Strength' is the perfect evening scent. It's bold, mysterious, and commands attention without being overpowering. The sillage is incredible, and I've received countless compliments. A proud addition to my collection.",
    product: "His-Strength",
    image: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=150&q=80",
    verified: true
  },
  {
    ...
    rating: 5,
    review: "I was skeptical about finding a high-quality Oud locally, but De-Hac's 'Oud' blew me away. It's deep, smokey, and incredibly regal. You can feel the quality of the ingredients from the very first spray. Exceptional craftsmanship.",
    product: "Oud",
    image: "https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=150&q=80",
    verified: true
  },
  {
    ...
    location: "Dubai, UAE",
    rating: 5,
    review: "'Florid' is my daily go-to. It's so fresh and vibrant, yet it has a staying power that is rare for floral-based perfumes. It reminds me of a breezy summer afternoon. De-Hac is definitely a brand to watch internationally.",
    product: "Florid",
    image: "https://images.unsplash.com/photo-1438761681033-6461ffad8d80?w=150&q=80",
    verified: true
  },
